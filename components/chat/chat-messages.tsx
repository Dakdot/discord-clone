  ...
  if (status === "error") {
    return (
      <div className="flex flex-col flex-1 justify-center items-center">
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-400 my-4">
          An error occurred when retrieving messages.
        </p>
      </div>
    );
  }
        ...
        <div className="flex justify-center">
          {isFetchingNextPage ? (
            ...
            <button
              ...
              className="text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 text-xs y-4 dark:hover:text-zinc-300 transition"
            >
